...
public class Check_RNAi_Construct_Tab_In_Tabbed_View_RNAI {
	...
	@Test(enabled = true, description = "Check different fields in Construct Tab of Sequence section RNAi", dataProvider = "checkDifferentFieldsInConstructTabSeq", groups = {
